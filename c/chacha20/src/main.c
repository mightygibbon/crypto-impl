...
int main()
{
    ...
    uint8_t chacha20_counter[4] = {
        0x00, 0x00, 0x00, 0x01
    };
    uint8_t chacha20_input[114] = {
    ...
    uint8_t chacha20_expected_out[114] = {
    ...
    chacha20_apply(chacha20_key, chacha20_nonce, chacha20_counter, chacha20_input, 114);

    for (size_t i = 0; i < 114; i++) {
        if (chacha20_input[i] != chacha20_expected_out[i]) {
            passed = false;
        }
    }

    if (passed) {
        printf("ChaCha20 Test Vector -> Passed\n");
    } else {
        printf("ChaCha20 Test Vector -> Failed\n");
    }
    ...
    if (passed) {
        printf("Poly1305 Test Vector -> Passed\n");
    } else {
        printf("Poly1305 Test Vector -> Failed\n");
    }
